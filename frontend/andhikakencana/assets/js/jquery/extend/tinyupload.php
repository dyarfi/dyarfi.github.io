...
//###### Config ######
$absPthToSlf = JS.'extend/tinyupload.php'; //The Absolute path (from the clients POV) to this file.
$absPthToDst = IMG.'/custom/'; //The Absolute path (from the clients POV) to the destination folder.
$absPthToDstSvr = $_SERVER['doc_root'].'asco/assets/images/custom/'; //The Absolute path (from the servers POV) to the destination folder. You will need to set permissions for this dir 0777 worked ok for me.
