...
$tinybrowser['obfuscate'] = 'KUM@-U5@6!';
...
$tinybrowser['docroot'] = str_replace('\\', '/', DOCROOT);
...
$tinybrowser['link']['image'] = URL::base().'uploads/images/'; // Image links

$tinybrowser['link']['media'] = URL::base().'uploads/media/'; // Media links

$tinybrowser['link']['file']  = URL::base().'uploads/files/'; // Other file links
...
$tinybrowser['tinymcecss'] = URL::base().'js/tiny_mce/themes/advanced/skins/default/dialog.css';
